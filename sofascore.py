...
def fetch_sofascore(sport="football", date_str=None):
    ...
    for event in events:
        try:
            ...
            home_logo = f"https://api.sofascore1.com/api/v1/team/{home_id}/image" if home_id else ""
            away_logo = f"https://api.sofascore1.com/api/v1/team/{away_id}/image" if away_id else ""
